...
const processMessageAsync = async (payload) => {
    try {
        ...
        if (!rateLimitCheck.allowed) {
            ...
            await queueTextMessage(from, "You're sending messages too quickly. Please wait a moment and try again.", clientUserId ? { clientUserId } : null);
            return;
        }
...
//# sourceMappingURL=webhookProduction.js.map